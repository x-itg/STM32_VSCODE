...
static const char device_name[] = "Tarzan";
static bool is_connect = false;
static uint16_t spp_conn_id = 0;
static uint16_t spp_mtu_size = 251; // 23;
...
void ble_client_appRegister(void)
{
    ...
    esp_err_t local_mtu_ret = esp_ble_gatt_set_local_mtu(251); // 200
    if (local_mtu_ret)
    {
