...
#define GATTS_TABLE_TAG "Tarzan" // GATTS_SPP_DEMO

#define SPP_PROFILE_NUM 1
#define SPP_PROFILE_APP_IDX 0
#define ESP_SPP_APP_ID 0x56
#define SAMPLE_DEVICE_NAME "Tarzan" // The Device Name Characteristics in GAP
...
#define ESP_GATT_UUID_SPP_DATA_NOTIFY 0xFFE3
#define ESP_GATT_UUID_SPP_COMMAND_RECEIVE 0xFFE2
#define ESP_GATT_UUID_SPP_COMMAND_NOTIFY 0xFFE4

#ifdef SUPPORT_HEARTBEAT
#define ESP_GATT_UUID_SPP_HEARTBEAT 0xFFE5
#endif
