...
void LoadPara(void)
{
  ...
  if(Tcala4<-1000||Tcala4>1000)Tcala4=0;
  readAT24C16(addrTcala5,(unsigned char *)&Tcala5,4);
  if(Tcala5<-1000||Tcala5>1000)Tcala5=0;
  ...
  if(cshuiCha<HCLow||cshuiCha>HCHig)cshuiCha=50;
  readAT24C16(addrcwhuiCha,(unsigned char *)&cwhuiCha,4);
  if(cwhuiCha<HCLow||cwhuiCha>HCHig)cwhuiCha=50;
  readAT24C16(addrtzhuiCha,(unsigned char *)&tzhuiCha,4);
  if(tzhuiCha<HCLow||tzhuiCha>HCHig)tzhuiCha=50;
...
{ 
  ...
  if(cnt>3000)
  {
    ...
    {
#if 1
      if(JDQSTAT==0)Ta=(signed int)((k[0]*(float)max[0]-b[0])+(float)Tcala1);//+(float)Tcala1;//
      if(JDQSTAT==0)Tb=(signed int)((k[1]*(float)max[1]-b[1])+(float)Tcala2);//+(float)Tcala2;//
      if(JDQSTAT==0)Tc=(signed int)((k[2]*(float)max[2]-b[2])+(float)Tcala3);//+(float)Tcala3;//
      if(JDQSTAT==0)Td=(signed int)((k[3]*(float)max[3]-b[3])+(float)Tcala4);//+(float)Tcala3;//
      if(JDQSTAT==0)Te=(signed int)((k[4]*(float)max[4]-b[4])+(float)Tcala5);//+(float)Tcala3;//
#if TeStFlag==1
      Ta=-10;
      Tb=-10;
      Tc=-10;
  ...
  }else
  {
    ...
    if(max[3]<AdcValue[3])max[3]=AdcValue[3];
    if(max[4]<AdcValue[4])max[4]=AdcValue[4];
  }
...
void shValue(signed int Num,unsigned char dp,unsigned char mode)
{
  ...
  if(Num<=10000&&Num>=-999)
  {
    ...
    if(shStr[0]==0)tmNum[1]=16;//不显示任何东西
    if(shStr[1]==0)tmNum[2]=16;//不显示任何东西
    if(shStr[2]==0)tmNum[3]=16;//不显示任何东西
    if(shStr[3]==0)tmNum[4]=16;//不显示任何东西
      
    if(mode==0&&Num<10&&Num>-10)tmNum[3]=18;//0.
    if(mode==4&&Num<10&&Num>-10&&dp==1)tmNum[3]=18;//0.
...
void UpateShData(void)
{
  ...
  if(macFlag[17]==1){if(TestModeFlag==0)JDQ5_H;else JDQ5_L;}//0
  if(macFlag[17]!=1){if(TestModeFlag==0)JDQ5_L;}
  if(macFlag[18]==1){if(TestModeFlag==0)JDQ6_H;else JDQ6_L;}//1
  if(macFlag[18]!=1){if(TestModeFlag==0)JDQ6_L;}
  if(macFlag[19]==1){if(TestModeFlag==0)JDQ7_H;else JDQ7_L;}//2
  if(macFlag[19]!=1){if(TestModeFlag==0)JDQ7_L;}
  if(macFlag[20]==1){if(TestModeFlag==0)JDQ8_H;else JDQ8_L;}//3
  if(macFlag[20]!=1){if(TestModeFlag==0)JDQ8_L;}
  if(macFlag[21]==1){if(TestModeFlag==0)JDQ9_H;else JDQ9_L;}//4
  if(macFlag[21]!=1){if(TestModeFlag==0)JDQ9_L;}
  if(macFlag[22]==1){if(TestModeFlag==0)JDQ10_H;else JDQ10_L;}//5
  if(macFlag[22]!=1){if(TestModeFlag==0)JDQ10_L;}
  ...
  if(macFlag[14]==1&&macFlag[15]==0)willBeepTime=100;
  if(macFlag[14]==0||macFlag[15]==1)willBeepTime=0;
  if(macFlag[16]==1){LedFlag=LedFlag|0x20;}//最大 0010 0000
  ...
  if(readKeyTime>10)
  {
    ...
    case indexMain_A://初始显示 A温度
      ...
      if(KeyV==1&&lCnt1>=40)
      {
        tmNum[6]=indexMain_S;KeyV=0;lCnt1=0;break;
      }
      if(KeyV==4&&lCnt4>=40)
      {
        KeyV=0;
        if(macFlag[16]==0)macFlag[16]=1;
        else macFlag[16]=0;
        break;
      }//巡回
      ...
      {
        KeyV=0;
        if(macFlag[12]==0)macFlag[12]=1;
        else macFlag[12]=0;break;
      }
      if(KeyV==3)
      {
        KeyV=0;
        if(macFlag[12]==0)macFlag[12]=2;
        else macFlag[12]=0;
        break;
      }
      if(macFlag[16]==0)//巡回
      {
        ...
        {
          xunhuiCnt=0;
          tmNum[6]=indexMain_B;break;
        }
      }else
      {
        if(Tb>Ta){xunhuiCnt=0;tmNum[6]=indexMain_B;break;}
      }
      KeyV=0;
      break;
    case indexMain_B://B温度
      ...
      //shValue(Tb,1,0);
      if(KeyV==1&&lCnt1>=60){tmNum[6]=indexMain_S;KeyV=0;lCnt1=0;break;}
      if(KeyV==4&&lCnt4>=40){KeyV=0;if(macFlag[16]==0)macFlag[16]=1;else macFlag[16]=0;break;}//巡回
      if(KeyV==4&&Key4ReadNone){tmNum[6]=indexMain_A;KeyV=0;if(macFlag[15]==0)macFlag[15]=1;else macFlag[15]=0;break;}//消音
      ...
      if(macFlag[16]==0)//巡回
      {
        if(xunhuiCnt>=XHTIME){xunhuiCnt=0;tmNum[6]=indexMain_C;break;}
      }else
      {
        if(Tc>Tb){xunhuiCnt=0;tmNum[6]=indexMain_C;break;}
      }
      break;
    case indexMain_C://C温度
      ...
      if(macFlag[16]==0)//巡回
      {
        if(xunhuiCnt>=XHTIME){xunhuiCnt=0;tmNum[6]=indexMain_D;break;}
      }else
      {
        if(Ta>Tc){xunhuiCnt=0;tmNum[6]=indexMain_D;break;}
      }
      break;
    ...
    case indexMain_D://D温度
      ...
      if(dehD==0){xunhuiCnt=0;tmNum[6]=indexMain_E;}
      ...
      if(macFlag[16]==0)//巡回
      {
        if(xunhuiCnt>=XHTIME){xunhuiCnt=0;tmNum[6]=indexMain_E;break;}
      }else
      {
        if(Ta>Td){xunhuiCnt=0;tmNum[6]=indexMain_A;break;}
      }
      break;    
    ...
    case indexMain_E://E温度
      ...
      if(dehE==0){xunhuiCnt=0;tmNum[6]=indexMain_H;}
      ...
      if(macFlag[16]==0)//巡回
      {
        if(xunhuiCnt>=XHTIME){xunhuiCnt=0;tmNum[6]=indexMain_H;break;}
      }
      else
      {
        if(Ta>Te){xunhuiCnt=0;tmNum[6]=indexMain_A;break;}
      }
      break; 
    ...
    case indexMain_H://H湿度
      ...
      if(dehH==0){xunhuiCnt=0;tmNum[6]=indexMain_A;}
      ...
      if(macFlag[16]==0)//巡回
      {
        if(xunhuiCnt>=XHTIME){xunhuiCnt=0;tmNum[6]=indexMain_A;break;}
      } 
      break; 
      //主页      00.A20.0  01.B20.0   02.C20.0
      //菜单**PXX 03.P0X
    ...
    case indexMain_S://P XX    在这里跳转编辑功能
      ...
      {
        LoopCnt=0;
        if(Pcnt==1)tmNum[6]=indexHist_A;
        if(Pcnt==2)tmNum[6]=indexFen_1;
        if(Pcnt==3)tmNum[6]=indexCala0_A;
        if(Pcnt==4)tmNum[6]=indexTSet_A10;
        if(Pcnt==5)tmNum[6]=indexTest1;
        if(Pcnt==6)tmNum[6]=indexCom1;
        if(Pcnt==8)tmNum[6]=indexFH_1;
        if(Pcnt==9)tmNum[6]=indexBC_1;
        if(Pcnt==10)tmNum[6]=indexDEH_D;
        if(Pcnt==11)tmNum[6]=indexa5;
        if(Pcnt==12)tmNum[6]=indexa8;
        KeyV=0;
      }
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){if(Pcnt<12)Pcnt++;KeyV=0;if(Pcnt==7)Pcnt=8;}
      if(KeyV==3){if(Pcnt>1)Pcnt--;KeyV=0;if(Pcnt==7)Pcnt=6;}
    ...
    case indexHist_A://P 01下面的断电前温度查看
      tmNum[0]=0xA;//显示A
      shValue(pTa,1,0);
      if(KeyV==1){tmNum[6]=indexHist_B;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexHist_B://P 01下面的断电前温度查看
      tmNum[0]=0xb;//显示b
      shValue(pTb,1,0);
      if(KeyV==1){tmNum[6]=indexHist_C;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexHist_C://P 01下面的断电前温度查看
      tmNum[0]=0xC;//显示C
      shValue(pTc,1,0);
      if(KeyV==1){tmNum[6]=indexMain_D;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexHist_D://P 01下面的断电前温度查看
      tmNum[0]=0xD;//显示D
      shValue(pTd,1,0);
      if(KeyV==1){tmNum[6]=indexMain_E;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexHist_E://P 01下面的断电前温度查看
      tmNum[0]=0xE;//显示D
      shValue(pTe,1,0);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexFen_1://P 02 风机定时
      ...
      if(KeyV==1){tmNum[6]=indexFen_2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexFen_2://P 02 风机定时小时
      tmNum[0]=31;//显示H
      shValue(FenH,0,2);
      if(KeyV==1){tmNum[6]=indexFen_3;KeyV=0;writeAT24C16(addrFenH,(unsigned char *)&FenH,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexFen_3://P 02 风机定时分钟
      tmNum[0]=30;//显示h
      shValue(FenM,0,2);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrFenM,(unsigned char *)&FenM,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexCala0_A://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala0_B;KeyV=0;x1[0]=AdcValue[0];}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;  
    ...
    case indexCala0_B://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala0_C;KeyV=0;x1[1]=AdcValue[1];}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break; 
    ...
    case indexCala0_C://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala0_D;KeyV=0;x1[2]=AdcValue[2];}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;  
    ...
    case indexCala0_D://P 04 温度公式计算
      tmNum[0]=0xD;tmNum[1]=0x0;tmNum[2]=0x0;tmNum[3]=0x0;tmNum[4]=0x0;
      if(KeyV==1){tmNum[6]=indexCala0_E;KeyV=0;x1[3]=AdcValue[3];}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break; 
    ...
    case indexCala0_E://P 04 温度公式计算
      tmNum[0]=0xE;tmNum[1]=0x0;tmNum[2]=0x0;tmNum[3]=0x0;tmNum[4]=0x0;
      if(KeyV==1){tmNum[6]=indexCala1_A;KeyV=0;x1[4]=AdcValue[4];}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexCala1_A://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala1_B;KeyV=0;x2[0]=AdcValue[0];k[0]=2000.0/(x2[0]-x1[0]);b[0]=k[0]*x1[0];
    ...
    case indexCala1_B://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala1_C;KeyV=0;x2[1]=AdcValue[1];k[1]=2000.0/(x2[1]-x1[1]);b[1]=k[1]*x1[1];
    ...
    case indexCala1_C://P 04 温度公式计算
      ...
      if(KeyV==1){tmNum[6]=indexCala1_D;KeyV=0;x2[2]=AdcValue[2];k[2]=2000.0/(x2[2]-x1[2]);b[2]=k[2]*x1[2];
    ...
    case indexCala1_D://P 04 温度公式计算
      tmNum[0]=0xD; tmNum[1]=0x0;tmNum[2]=0x2;tmNum[3]=0x0;tmNum[4]=0x0;
      if(KeyV==1){tmNum[6]=indexCala1_E;KeyV=0;x2[3]=AdcValue[3];k[3]=2000.0/(x2[3]-x1[3]);b[3]=k[3]*x1[3];
      writeAT24C16(addrk2,(unsigned char *)&k[3],4);
      writeAT24C16(addrb2,(unsigned char *)&b[3],4);
      }
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
    ...
    case indexCala1_E://P 04 温度公式计算
      tmNum[0]=0xE; tmNum[1]=0x0;tmNum[2]=0x2;tmNum[3]=0x0;tmNum[4]=0x0;
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;x2[4]=AdcValue[4];k[4]=2000.0/(x2[4]-x1[4]);b[4]=k[4]*x1[4];
      writeAT24C16(addrk3,(unsigned char *)&k[4],4);
      writeAT24C16(addrb3,(unsigned char *)&b[4],4);
      TestModeFlag=0;
      MnTest=0;
      }
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexTSet_A10://P 04 温度设定
      ...
      if(KeyV==1){tmNum[6]=indexTSet_A11;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexTSet_A11://风机启动温度
      tmNum[0]=30;
      shValue(Tset1,1,0);
      if(KeyV==1){tmNum[6]=indexTSet_A20;KeyV=0;writeAT24C16(addrTset1,(unsigned char *)&Tset1,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexTSet_A20:// 
      ...
      tmNum[3]=0x2;
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexTSet_A21;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexTSet_A21://风机停止温度
      tmNum[0]=30;
      shValue(Tset2,1,0);
      if(KeyV==1){tmNum[6]=indexTSet_A30;KeyV=0;writeAT24C16(addrTset2,(unsigned char *)&Tset2,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexTSet_A30:// 
      ...
      tmNum[3]=0x3;
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexTSet_A31;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexTSet_A31://超温
      tmNum[0]=30;
      shValue(Tset3,1,0);
      if(KeyV==1){tmNum[6]=indexTSet_A40;KeyV=0;writeAT24C16(addrTset3,(unsigned char *)&Tset3,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexTSet_A40:// 
      ...
      tmNum[3]=0x3;
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexTSet_A41;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexTSet_A41://风机停止温度
      tmNum[0]=30;
      shValue(Tset4,1,0);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrTset4,(unsigned char *)&Tset4,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexTest1://P 05 模拟测试
      ...
      tmNum[3]=31;//H
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexTest2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexTest2://模拟测试
      ...
      tmNum[0]=30;
      shValue(MnTest,1,0);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;TestModeFlag=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;TestModeFlag=0;}
    ...
    case indexCom1://P 06 串口
      ...
      tmNum[3]=0xd;//d
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexCom2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexCom2://地址
      tmNum[0]=30;
      shValue(addr,0,3);
      if(KeyV==1){tmNum[6]=indexCom3;KeyV=0;writeAT24C16(addraddr,(unsigned char *)&addr,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexCom3://奇偶校验
      tmNum[0]=30;
      shValue(jojy,0,1);
      if(KeyV==1){tmNum[6]=indexCom4;KeyV=0;writeAT24C16(addrjojy,(unsigned char *)&jojy,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexCom4://波特率
      tmNum[0]=30;
      shValue(btlv,0,1);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrbtlv,(unsigned char *)&btlv,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexFH_1://P 08 回差
      ...
      tmNum[3]=31;//H
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexFH_2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexFH_2://
      ...
      if(KeyV==1){tmNum[6]=indexF3_1;KeyV=0;readAT24C16(addrcshuiCha,(unsigned char *)&cshuiCha,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexF3_1://P 08 回差
      ...
      tmNum[3]=0x3;//3
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexF3_2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexF3_2://
      ...
      if(KeyV==1){tmNum[6]=indexF4_1;KeyV=0;readAT24C16(addrcwhuiCha,(unsigned char *)&cwhuiCha,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexF4_1://P 08 回差
      ...
      tmNum[3]=0x3;//3
      tmNum[4]=29;//-
      if(KeyV==1){tmNum[6]=indexF4_2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexF4_2://
      ...
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;readAT24C16(addrtzhuiCha,(unsigned char *)&tzhuiCha,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexBC_1://P 03 温度补偿
      ...
      if(KeyV==1){tmNum[6]=indexBC_2;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexBC_2://温度补偿a
      tmNum[0]=0xA;
      shValue(Tcala1,1,4);
      if(KeyV==1){tmNum[6]=indexBC_3;KeyV=0;writeAT24C16(addrTcala1,(unsigned char *)&Tcala1,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2&&Key2ReadNone){if(Tcala1<BcValHig)Tcala1++;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tcala1>BcValLow)Tcala1--;KeyV=0;}
      if(KeyV==2&&lCnt2>=40){if(Tcala1<BcValHig)Tcala1++;}
      if(KeyV==3&&lCnt3>=40){if(Tcala1>BcValLow)Tcala1--;}
      break;
      
    case indexBC_3://温度补偿b
      tmNum[0]=0xb;
      shValue(Tcala2,1,4);
      if(KeyV==1){tmNum[6]=indexBC_4;KeyV=0;writeAT24C16(addrTcala2,(unsigned char *)&Tcala2,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexBC_4://温度补偿C
      tmNum[0]=0xC;
      shValue(Tcala3,1,4);
      if(KeyV==1){tmNum[6]=indexBC_5;KeyV=0;writeAT24C16(addrTcala3,(unsigned char *)&Tcala3,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
    ...
    case indexBC_5://温度补偿d
      tmNum[0]=0xd;
      shValue(Tcala4,1,4);
      if(KeyV==1){tmNum[6]=indexBC_6;KeyV=0;writeAT24C16(addrTcala4,(unsigned char *)&Tcala4,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2&&Key2ReadNone){if(Tcala4<BcValHig)Tcala4++;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tcala4>BcValLow)Tcala4--;KeyV=0;}
      if(KeyV==2&&lCnt2>=40){if(Tcala4<BcValHig)Tcala4++;}
      if(KeyV==3&&lCnt3>=40){if(Tcala4>BcValLow)Tcala4--;}
      break;
      
    case indexBC_6://温度补偿e
      tmNum[0]=0xe;
      shValue(Tcala5,1,4);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrTcala5,(unsigned char *)&Tcala5,4);}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2&&Key2ReadNone){if(Tcala5<BcValHig)Tcala5++;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tcala5>BcValLow)Tcala5--;KeyV=0;}
      if(KeyV==2&&lCnt2>=40){if(Tcala5<BcValHig)Tcala5++;}
      if(KeyV==3&&lCnt3>=40){if(Tcala5>BcValLow)Tcala5--;}
      break;
    ...
    case indexDEH_D://温度D是否参数循环显示
      tmNum[0]=0xd;
      shValue(dehD,0,1);
      if(KeyV==1){tmNum[6]=indexDEH_E;KeyV=0;writeAT24C16(addrdehD,(unsigned char *)&dehD,1);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){dehD=1;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){dehD=0;KeyV=0;}
     
      break;
    case indexDEH_E://温度E是否参与循环显示
      tmNum[0]=0xE;
      shValue(dehE,0,1);
      if(KeyV==1){tmNum[6]=indexDEH_H;KeyV=0;writeAT24C16(addrdehE,(unsigned char *)&dehE,1);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){dehE=1;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){dehE=0;KeyV=0;}
     
      break;
    case indexDEH_H://H是否参数循环显示
      tmNum[0]=31;
      shValue(dehH,0,1);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrdehH,(unsigned char *)&dehH,1);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){dehH=1;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){dehH=0;KeyV=0;}
    ...
    case indexa5://A5__A
      ...
      if(KeyV==1){tmNum[6]=indexa590;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexa590://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqk[0],1,4);
      if(KeyV==1){tmNum[6]=indexb5;KeyV=0;writeAT24C16(addrTjdqk0,(unsigned char *)&Tjdqk[0],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqk[0]<1500)Tjdqk[0]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqk[0]>200)Tjdqk[0]--;KeyV=0;}
    ...
    case indexb5:////A5__B
      ...
      if(KeyV==1){tmNum[6]=indexb5100;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexb5100://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqb[0],1,4);
      if(KeyV==1){tmNum[6]=indexa6;KeyV=0;writeAT24C16(addrTjdqb0,(unsigned char *)&Tjdqb[0],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqb[0]<1500)Tjdqb[0]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqb[0]>200)Tjdqb[0]--;KeyV=0;}
     ...
     case indexa6://A6__A
      ...
      if(KeyV==1){tmNum[6]=indexa690;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexa690://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqk[1],1,4);
      if(KeyV==1){tmNum[6]=indexb6;KeyV=0;writeAT24C16(addrTjdqk1,(unsigned char *)&Tjdqk[1],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqk[1]<1500)Tjdqk[1]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqk[1]>200)Tjdqk[1]--;KeyV=0;}
    ...
    case indexb6:////A6__B
      ...
      if(KeyV==1){tmNum[6]=indexb6100;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexb6100: 
      tmNum[0]=0xA;
      shValue(Tjdqb[1],1,4);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrTjdqb1,(unsigned char *)&Tjdqb[1],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqb[1]<1500)Tjdqb[1]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqb[1]>200)Tjdqb[1]--;KeyV=0;}
    ...
    //---
      ...
      if(KeyV==1){tmNum[6]=indexa890;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexa890://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqk[3],1,4);
      if(KeyV==1){tmNum[6]=indexb8;KeyV=0;writeAT24C16(addrTjdqk3,(unsigned char *)&Tjdqk[3],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqk[3]<1500)Tjdqk[3]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqk[3]>200)Tjdqk[3]--;KeyV=0;}
    ...
    case indexb8://A5__A
      ...
      if(KeyV==1){tmNum[6]=indexb8100;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexb8100://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqb[3],1,4);
      if(KeyV==1){tmNum[6]=indexa9;KeyV=0;writeAT24C16(addrTjdqb3,(unsigned char *)&Tjdqb[3],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqb[3]<1500)Tjdqb[3]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqb[3]>200)Tjdqb[3]--;KeyV=0;}
    ...
    case indexa9://A9__A
      ...
      if(KeyV==1){tmNum[6]=indexa990;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexa990://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqk[4],1,4);
      if(KeyV==1){tmNum[6]=indexb9;KeyV=0;writeAT24C16(addrTjdqk4,(unsigned char *)&Tjdqk[4],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqk[4]<1500)Tjdqk[4]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqk[4]>200)Tjdqk[4]--;KeyV=0;}
     ...
     case indexb9://A9__B
      ...
      if(KeyV==1){tmNum[6]=indexb9100;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexb9100://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqb[4],1,4);
      if(KeyV==1){tmNum[6]=indexa10;KeyV=0;writeAT24C16(addrTjdqb4,(unsigned char *)&Tjdqb[4],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqb[4]<1500)Tjdqb[4]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqb[4]>200)Tjdqb[4]--;KeyV=0;}
    ...
    case indexa10://A10__A
      ...
      if(KeyV==1){tmNum[6]=indexa1090;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexa1090://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqk[5],1,4);
      if(KeyV==1){tmNum[6]=indexb10;KeyV=0;writeAT24C16(addrTjdqk5,(unsigned char *)&Tjdqk[5],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqk[5]<1500)Tjdqk[5]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqk[5]>200)Tjdqk[5]--;KeyV=0;}
     ...
     case indexb10://A10__B
      ...
      if(KeyV==1){tmNum[6]=indexb10100;KeyV=0;}
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}
      if(KeyV==2){KeyV=0;}
      if(KeyV==3){KeyV=0;}
      break;
    ...
    case indexb10100://温度E是否参与循环显示
      tmNum[0]=0xA;
      shValue(Tjdqb[5],1,4);
      if(KeyV==1){tmNum[6]=indexMain_S;KeyV=0;writeAT24C16(addrTjdqb5,(unsigned char *)&Tjdqb[5],2);}//确认
      if(KeyV==4){tmNum[6]=indexMain_A;KeyV=0;}//退出
      if(KeyV==2&&Key2ReadNone){if(Tjdqb[5]<1500)Tjdqb[5]++;;KeyV=0;}
      if(KeyV==3&&Key3ReadNone){if(Tjdqb[5]>200)Tjdqb[5]--;KeyV=0;}
