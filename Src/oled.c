  ...
  while (i < Len)
  {
    ...
    if (c1 > 128)
    {
      ...
      if (j == k && (c1 != Hzk[j].Index[0] || c2 != Hzk[j].Index[1]))
      {
        ...
        if ((i + ucX) < 32)
        {
          OLED_ShowCHinese(i * 8 + 8 * ucX, 2 * ucY, (unsigned char *)&Hzk[0].Msk[0], revyn); // ����?��?��2?��??���䨰��?�̨���???oo��?
        }
      }
      else
      {
